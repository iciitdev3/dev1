    ...
    return (
      <Card className="max-w-3xl mx-auto border-0 shadow-xl">
        <CardContent className="p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('excellent')} Emotional Intelligence!</h2>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>{t('emotionalLabeling')}</span>
                </CardTitle>
                <p className="text-sm text-gray-600 mt-1">
                  {t('scenarios')} {currentScenario + 1} of {emotionalScenarios.length} - Identify client emotions
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                >
                  {currentScenario < emotionalScenarios.length - 1 ? (
                   ...
                   console.info("sd") // {t('complete')} {t('exercises')}
                  )}
                </Button>
              </div>
            )}
