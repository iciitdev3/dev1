    ...
    return (
      <Card className="max-w-3xl mx-auto border-0 shadow-xl">
        <CardContent className="p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Exposure {t('completed')}!</h2>
          ...
          <CardContent className="p-6">
            <div className="space-y-6">
              ...
              >
                ...
                {currentRehearsal < 2 ? t('complete') + ' Rehearsal & ' + t('continue') : t('complete') + ' Final Rehearsal'}
              </Button>
            </div>
          </CardContent>
        </Card>
      ...
      {completedRehearsals.length > 0 && (
        <Card className="mt-6 border-0 shadow-lg bg-purple-50">
          <CardContent className="p-4">
            <h3 className="font-medium text-gray-900 mb-3">{t('completed')} Rehearsals:</h3>
            <div className="space-y-2">
