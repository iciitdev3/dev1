    ...
    return (
      <Card className="max-w-3xl mx-auto border-0 shadow-xl">
        <CardContent className="p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('woopExercise')} Plan {t('completed')}!</h2>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6 text-left">
            <h3 className="font-bold text-gray-900 mb-4 text-center">{t('yourResponse')} WOOP Plan:</h3>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>{t('woopExercise')}</span>
                </CardTitle>
                <p className="text-sm text-gray-600 mt-1">
                  {t('stepOf', { current: currentStep, total: 4 })} - Plan Your First Call of the Day
                </p>
              </div>
            </div>
            <div className="text-right">
              <div className="text-sm text-gray-500 mb-1">{Math.round((currentStep / 4) * 100)}% {t('completed')}</div>
        ...
        <CardContent className="p-6">
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-center pt-4">
              ...
              >
                <span>{currentStep === 4 ? t('complete') + ' WOOP' : t('nextStep')}</span>
