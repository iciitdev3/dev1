    ...
    return (
      <Card className="max-w-3xl mx-auto border-0 shadow-xl">
        <CardContent className="p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('excellent')} Work!</h2>
          ...
          <div className="grid grid-cols-2 gap-4 max-w-md mx-auto mb-6">
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600">{t('reflections')}</p>
            </div>
            <div className="bg-green-50 rounded-lg p-4">
              <p className="text-2xl font-bold text-green-600">{formatTime(120 - timeLeft)}</p>
              <p className="text-sm text-gray-600">{t('timeUsed')}</p>
            </div>
          </div>
          <div className="bg-blue-50 rounded-lg p-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>AI Client {t('roleplayDialogue')}</span>
                </CardTitle>
            ...
            <div className="flex items-center space-x-4">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500">{t('reflections')}</div>
              </div>
              <div className="text-center">
        ...
        <Card className="border-0 shadow-lg">
          ...
          <CardContent className="p-6">
            ...
            {reflections.length > 0 && (
              <div className="mt-6">
                <h4 className="font-medium text-gray-900 mb-3">{t('yourResponse')} {t('reflections')}:</h4>
