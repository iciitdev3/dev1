    ...
    return (
      <Card className="max-w-3xl mx-auto border-0 shadow-xl">
        <CardContent className="p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('perspectiveReframe')} Mastery Achieved!</h2>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>{t('perspectiveReframe')}</span>
                </CardTitle>
                <p className="text-sm text-gray-600 mt-1">
                  {t('stepOf', { current: currentStep, total: totalSteps })} - Challenge Rigid Thinking Patterns
                </p>
              </div>
            </div>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>{t('yourResponse')} Reframe</span>
            </CardTitle>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              <div className="flex space-x-3">
                ...
                >
                  {currentStep === totalSteps ? t('complete') + ' ' + t('exercises') : t('next') + ' Perspective'}
                </Button>
              </div>
            </div>
          </CardContent>
      ...
      <Card className="mt-6 border-0 shadow-lg bg-indigo-50">
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-medium text-gray-900">Perspective {t('progress')}</h3>
